                        ...
                        <div class="pt-3  z-40">
                            ...
                            <div id="containerGame" class="w-full rounded-lg">
                                <div id="hud" class="text-center font-bold mb-5 text-normal flex justify-between px-7 mt-6">
                                    <div class="bg-white rounded-full px-4">{{ __('Goal') }}: <span id="scoreToWin">20</span></div>
                                    <div class="bg-white rounded-full px-4">{{ __('Score') }}: <span id="score">0</span></div>
                                    <div class="bg-white rounded-full px-4">{{ __('Time') }}: <span id="time">30</span>s</div>
                                </div>
