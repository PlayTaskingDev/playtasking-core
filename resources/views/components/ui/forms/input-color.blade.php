...
<div class="">
  <div
    ...
    class="rounded-xl border border-zinc-200 p-4 dark:border-zinc-700/50"
  >
    <!-- Input -->
    <div class="space-y-1">
      <label
      ...
      <div class="relative">
        ...
        <input
          ...
          required
          {{ 
              $attributes->merge(['class'=>'block w-full rounded-lg border border-zinc-200 py-2 pe-3 ps-11 text-sm/6 placeholder-zinc-500 dark:border-zinc-600 dark:bg-transparent dark:placeholder-zinc-400']) 
          }} 
        />
      </div>
    </div>
