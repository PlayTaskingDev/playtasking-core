            ...
            @php
                $notifications = [
                    [
                        ...
                        'userImage' => 'https://free-demo.tailadmin.com/src/images/user/user-02.jpg',
                    ...
                    [
                        ...
                        'userImage' => 'https://free-demo.tailadmin.com/src/images/user/user-03.jpg',
                        'action' => 'requests permission to change',
                        'project' => 'Project - Nganter App',
                        'type' => 'Project',
                        'time' => '10 min ago',
                    ...
                    [
                        ...
                        'userImage' => 'https://free-demo.tailadmin.com/src/images/user/user-04.jpg',
                        'action' => 'requests permission to change',
                    ...
                    [
                        'id' => 4,
                        'userName' => 'Mike Brown',
                        'userImage' => 'https://free-demo.tailadmin.com/src/images/user/user-05.jpg',
                        'action' => 'requests permission to change',
                    ...
                    [
                        'id' => 5,
                        'userName' => 'Emma Davis',
                        'userImage' => 'https://free-demo.tailadmin.com/src/images/user/user-06.jpg',
                        'action' => 'requests permission to change',
                    ...
                    [
                        'id' => 6,
                        'userName' => 'John Smith',
                        'userImage' => 'https://free-demo.tailadmin.com/src/images/user/user-07.jpg',
                        'action' => 'requests permission to change',
                    ...
                    [
                        ...
                        'userImage' => 'https://free-demo.tailadmin.com/src/images/user/user-08.jpg',
                        'action' => 'requests permission to change',
                    ...
                    [
                        ...
                        'userImage' => 'https://free-demo.tailadmin.com/src/images/user/user-09.jpg',
                        'action' => 'requests permission to change',
