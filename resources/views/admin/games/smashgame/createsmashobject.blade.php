...
@section('content')
    <div class="py-6 mx-5">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8 bg-white p-3 rounded shadow">
            ...
            action="{{ $smash_object->id == null ? route('smashgameobjects.store', ['tenant' => tenant('id')]) : route('smashgameobjects.update', ['tenant' => tenant('id'), 'smashgameobject' => $smash_object]) }}">
            @csrf
            ...
            <div class="flex my-5">
                ...
                @if (!is_null($smash_object->id))
                    <a href="{{ route('catchgameobjects.edit', ['tenant' => tenant('id'), 'catchgameobject' => $smash_object]) }}"
