...
<div id="aplazogame-modal" tabindex="-1"
    ...
    <div class="relative w-full max-w-3xl rounded-3xl bg-white p-6">
        <div class="flex justify-between items-center mb-4">
            ...
            <button data-modal-hide="aplazogame-modal" class="text-gray-400 hover:text-gray-600">
                ✕
            </button>
        </div>
        <form id="form-aplazogame" method="POST" enctype="multipart/form-data">
