...
@section('content')
    ...
    <div class="space-y-6">
        ...
        <div class="w-full flex justify-end">
            <a
                data-action="create"
                href="{{ route('memorygames.create', ['tenant' => tenant('id')]) }}"
                class="btn bg-brand-500 hover:bg-brand-600 flex w-full justify-center rounded-lg px-4 py-2.5 text-sm font-medium text-white sm:w-auto" aria-label="{{ __('Add new MemoryGame') }}">
                {{ __('Add MemoryGame +') }}
            </a>
        </div>
