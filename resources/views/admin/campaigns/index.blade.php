...
@section('content')
    @if (session('status'))
        ...
        />
    @endif
    <x-v2.common.page-breadcrumb pageTitle="{{ $title }}" isBtn='1' modalId='' :titleBtn="__('Add Campaign +')" routeBtn="{{ route('campaigns.create', tenant('id')) }}" />
    <div class="space-y-6">
                ...
                <tbody>
                    @foreach ($campaigns as $campaign)
                        ...
                        <div class="flex items-center justify-start space-x-3">
                            <a
                            data-action="edit"
                            href="{{ route('campaigns.edit', [tenant('id'), $campaign]) }}"
