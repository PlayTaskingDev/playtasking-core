<x-panel-layout>
    ...
    <div class="py-6 mx-5">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8 bg-white p-3 rounded shadow">
            <form method="POST" enctype="multipart/form-data"
                action="{{ $catch_game->id == null ? route('catch_games.store', ['tenant' => tenant('id')]) : route('catch_games.update', ['tenant' => tenant('id'), 'catch_game' => $catch_game]) }}">
                @csrf
                @isset($catch_game->id)
                    @method('PATCH')
                    ...
                    <select id="campaign_id" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="campaign_id" required autofocus>
                        ...
                        @if ($campaigns)
                            @foreach ($campaigns as $campaign)
                                <option value="{{$campaign->id}}" {{(old('campaign_id') == $campaign->id ? 'selected' : (isset($catch_game->campaign) && $catch_game->campaign->id == $campaign->id ? 'selected' : ''))}}>{{$campaign->name}}</option>
                            @endforeach
                        @endif
                    </select>
                ...
                <div class="my-5">
                    ...
                    <x-text-input id="title" class="block mt-1 w-full" type="text" name="title"
                        :value="old('title', $catch_game->title)" required autofocus autocomplete="title" />
                ...
                <div class="my-5">
                    ...
                    <x-text-input id="description" class="block mt-1 w-full" type="text" name="description"
                        :value="old('description', $catch_game->description)" required autofocus autocomplete="description" />
                ...
                <div class="my-5 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        @if (!is_null($catch_game->id) && $catch_game->featured_image)
                            <img src="{{$catch_game->featured_image}}" alt="{{__('Quiz Featured Image')}}" title="{{__('Quiz Featured Image')}}" class="my-5">
                        @endif
                        <input
                    ...
                    <div>
                        ...
                        @if (!is_null($catch_game->id) && $catch_game->featured_image_disabled)
                            <img src="{{$catch_game->featured_image_disabled}}" alt="{{__('Quiz Disabled Image')}}" title="{{__('Quiz Disabled Image')}}" class="my-5">
                        @endif
                        <input
                            class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                ...
                <div class="my-5">
                    ...
                    <x-text-input id="slug" class="block mt-1 w-full" type="text" name="slug"
                        :value="old('slug', $catch_game->slug)" required autofocus autocomplete="slug" />
                ...
                <div class="my-5">
                    ...
                    <x-text-input id="seconds" class="block mt-1 w-full" type="number" name="seconds"
                        :value="old('seconds', $catch_game->seconds)" required autofocus autocomplete="seconds" />
                ...
                <div class="my-5">
                    ...
                    <x-text-input id="max_points" class="block mt-1 w-full" type="number" name="max_points"
                        :value="old('max_points', $catch_game->max_points)" required autofocus autocomplete="max_points" />
                ...
                <div class="my-5">
                    ...
                    <x-text-input id="points_per_object" class="block mt-1 w-full" type="number" name="points_per_object"
                        :value="old('points_per_object', $catch_game->points_per_object)" required autofocus autocomplete="points_per_object" />
                ...
                <div class="my-5 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        @if (!is_null($catch_game->id) && $catch_game->game_bg_image)
                            <img src="{{$catch_game->game_bg_image}}" alt="{{__('Game Background Image')}}" title="{{__('Game Background Image')}}" class="my-5">
                        @endif
                        <input
                            class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                            aria-describedby="game_bg_image_help" id="game_bg_image" name="game_bg_image" type="file">
                        <x-input-error class="mt-2" :messages="$errors->get('game_bg_image')" />
                        <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="game_bg_image_help">
                            {{__('Image must be less than 2MB and JPG or PNG format.')}}<br>
                        </div>
                    </div>
                    <div>
                        <x-input-label for="basket_image" :value="__('Basket Image')" />
                        @if (!is_null($catch_game->id) && $catch_game->basket_image)
                            <img src="{{$catch_game->basket_image}}" alt="{{__('Basket Image')}}" title="{{__('Basket Image')}}" class="my-5">
                        @endif
                        <input
                            class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                            aria-describedby="basket_image_help" id="basket_image" name="basket_image" type="file">
                        <x-input-error class="mt-2" :messages="$errors->get('basket_image')" />
                        <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="basket_image_help">
                            {{__('Image must be less than 2MB and JPG or PNG format.')}}
                        </div>
                    </div>
                </div>
                ...
                <div class="my-5 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input id="init_date" name="init_date" value="{{ old('init_date', $catch_game->init_date) }}" type="text" 
                    ...
                    <div>
                        ...
                        <input id="end_date" name="end_date" value="{{ old('end_date', $catch_game->end_date) }}" 
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="{{ __('Select date') }}">
                ...
                <h3 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight mb-5">{{__('Cards settings')}}</h3>
                <div class="my-5 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <x-text-input id="gradient_1" class="block mt-1 w-full" type="text" name="gradient_1"
                            :value="old('gradient_1', $catch_game->gradient_1)" required autofocus autocomplete="gradient_1" />
                    ...
                    <div>
                        ...
                        <x-text-input id="gradient_2" class="block mt-1 w-full" type="text" name="gradient_2"
                            :value="old('gradient_2', $catch_game->gradient_2)" required autofocus autocomplete="gradient_2" />
                ...
                <div class="my-5 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <x-text-input id="btn_background_color_1" class="block mt-1 w-full" type="text" name="btn_background_color_1"
                            :value="old('btn_background_color_1', $catch_game->btn_background_color_1)" required autofocus autocomplete="btn_background_color_1" />
                    ...
                    <div>
                        ...
                        <x-text-input id="btn_background_color_2" class="block mt-1 w-full" type="text" name="btn_background_color_2"
                            :value="old('btn_background_color_2', $catch_game->btn_background_color_2)" required autofocus autocomplete="btn_background_color_2" />
                ...
                <div class="my-5 grid grid-cols-2 gap-4">
                    <div>
                        <input id="btn_border" name="btn_border" type="checkbox" value="1" {{$catch_game->btn_border ? 'checked' : ''}}
                        ...
                        <div class="mt-3">
                            ...
                            <x-text-input id="btn_border_color" class="block mt-1 w-full" type="text" name="btn_border_color"
                                :value="old('btn_border_color', $catch_game->btn_border_color)" required autofocus autocomplete="btn_border_color" />
                    ...
                    <div>
                        <input id="btn_shadow" name="btn_shadow" type="checkbox" value="1" {{$catch_game->btn_shadow ? 'checked' : ''}}
                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <div class="mt-3">
                            ...
                            <x-text-input id="btn_text_color" class="block mt-1 w-full" type="text" name="btn_text_color"
                                :value="old('btn_text_color', $catch_game->btn_text_color)" required autofocus autocomplete="btn_text_color" />
                ...
                <div class="my-5 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <x-text-input id="btn_text_active" class="block mt-1 w-full" type="text" name="btn_text_active"
                            :value="old('btn_text_active', $catch_game->btn_text_active)" required autofocus autocomplete="btn_text_active" />
                    ...
                    <div>
                        ...
                        <x-text-input id="btn_text_inactive" class="block mt-1 w-full" type="text" name="btn_text_inactive"
                            :value="old('btn_text_inactive', $catch_game->btn_text_inactive)" required autofocus autocomplete="btn_text_inactive" />
                ...
                <div class="my-5">
                    ...
                    @if ($catch_game->game_banner)
                        <div id="delete_image_holder" class="relative">
                            <img src="{{$catch_game->game_banner}}" alt="{{__('Banner Image')}}" title="{{__('Banner Image')}}" class="my-5 w-full">
                ...
                <div class="my-5">
                    ...
                    <x-text-input id="game_banner_url" class="block mt-1 w-full" type="text" name="game_banner_url"
                        :value="old('game_banner_url', $catch_game->game_banner_url)" autofocus autocomplete="game_banner_url" />
                    <x-input-error :messages="$errors->get('game_banner_url')" class="mt-2" />
                </div>
                <div class="my-5">
                    <x-input-label for="game_banner_video" :value="__('Video')" />
                    @if (!is_null($catch_game->id) && $catch_game->game_banner_video)
                    ...
                    <x-text-input id="game_banner_video" class="block mt-1 w-full" type="text" name="game_banner_video"
                        :value="old('game_banner_video', $catch_game->game_banner_video)" autofocus autocomplete="game_banner_video" />
                ...
                <h3 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight mb-5">{{__('Failed Behaviour')}}</h3>
                <div class="my-5 grid grid-cols-2 gap-4">
                    <div>
                        <x-input-label for="failed_image" :value="__('Failed Image')" />
                        @if (!is_null($catch_game->id) && $catch_game->failed_image)
                            <img src="{{$catch_game->failed_image}}" alt="{{__('Quiz Failed Image')}}" title="{{__('Quiz Failed Image')}}" class="my-5">
                        @endif
                        <input
                            class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                            aria-describedby="failed_image_help" id="failed_image" name="failed_image" type="file">
                        <x-input-error class="mt-2" :messages="$errors->get('failed_image')" />
                        <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="failed_image_help">
                            {{__('Image must be less than 2MB and JPG or PNG format.')}}
                        </div>
                    </div>
                </div>
    ...
    @if (!is_null($catch_game->id))
            ...
            <div class="max-w-2xl mx-auto sm:px-6 lg:px-8 bg-white p-3 rounded shadow">
                <div class="flex justify-between">
                    ...
                    @if (is_null($catch_game->award))
                        <a href="{{ route('awards.create', ['tenant' => tenant('id'), 'awardable_id' => $catch_game, 'awardable_type' => 'App\Models\CatchGame' ]) }}"
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('awards.edit', ['tenant' => tenant('id'), 'award' => $catch_game->award]) }}"
        ...
        <div id="cards_container" class="py-6 mx-5">
            <div class="max-w-2xl mx-auto sm:px-6 lg:px-8 bg-white p-3 rounded shadow">
                <div class="flex justify-between">
                    <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight mb-5">
                        {{ __('Objects') }}</h2>
                    <a href="{{ route('catch_objects.create', ['tenant' => tenant('id'), 'catch_game_id' => $catch_game]) }}"
                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                        {{ __('Create') }} {{ __('Object') }}
                    </a>
                </div>
                        ...
                        <tbody>
                            @foreach ($catch_game->catch_objects as $object)
                                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('catch_objects.edit', ['tenant' => tenant('id'), 'catch_object' => $object]) }}"
                                            class="font-medium text-blue-600 dark:text-blue-500 hover:underline">{{ __('Edit') }}</a>
                                    </td>
                                </tr>
                            @endforeach
        ...
        <script>
            document.addEventListener("DOMContentLoaded", () => {
                ...
                const gradient3 = new ColorPicker({
                    color: '{{$catch_game->btn_background_color_1}}',
                    background: '#fff',
                ...
                const gradient4 = new ColorPicker({
                    color: '{{$catch_game->btn_background_color_2}}',
                    background: '#fff',
                ...
                const gradient5 = new ColorPicker({
                    color: '{{$catch_game->btn_border_color}}',
                    background: '#fff',
                ...
                const gradient6 = new ColorPicker({
                    color: '{{$catch_game->btn_text_color}}',
                    background: '#fff',
