<x-panel-layout>
    ...
    <x-slot name="description">
        {{ $question->id == null ? '' : $question->description }}
    </x-slot>
            ...
            <div class="max-w-2xl mx-auto sm:px-6 lg:px-8 bg-white p-3 rounded shadow">
                <div class="flex justify-between">
                    <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight mb-5">
                        {{ __('Answers') }}</h2>
                    <a href="{{ route('answers.create', ['tenant' => tenant('id'), 'question' => $question]) }}"
                        ...
                        <tbody>
                            @foreach ($question->answers as $answer)
                                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('answers.edit', ['tenant' => tenant('id'), 'answer' => $answer]) }}"
