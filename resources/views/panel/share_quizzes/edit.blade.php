<x-panel-layout>
    <x-slot name="title">
        {{ !is_null($share_quiz->title) ? $share_quiz->title : trans('Create') . '' . trans('Share Quiz') }}
    </x-slot>
    <x-slot name="description">
        {{ $share_quiz->id == null ? '' : $share_quiz->description }}
    </x-slot>

    <x-slot name="header">
        <h1 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ $share_quiz->id == null ? trans('Create') : trans('Edit') }} {{ __('Share Quiz') }}
        </h1>
    </x-slot>
    ...
    <div class="py-6 mx-5">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8 bg-white p-3 rounded shadow">
            <form method="POST" enctype="multipart/form-data"
                action="{{ $share_quiz->id == null ? route('share_quizzes.store', ['tenant' => tenant('id')]) : route('share_quizzes.update', ['tenant' => tenant('id'), 'share_quiz' => $share_quiz]) }}">
                @csrf
                @isset($share_quiz->id)
                    @method('PATCH')
                    <input type="hidden" name="id" value="{{ $share_quiz->id }}">
                @endisset
                    ...
                    <select id="campaign_id" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="campaign_id" required autofocus>
                        ...
                        @if ($campaigns)
                            @foreach ($campaigns as $campaign)
                                <option value="{{$campaign->id}}" {{(old('campaign_id') == $campaign->id ? 'selected' : (isset($share_quiz->campaign) && $share_quiz->campaign->id == $campaign->id ? 'selected' : ''))}}>{{$campaign->name}}</option>
                            @endforeach
                        @endif
                    </select>
                ...
                <div class="my-5">
                    ...
                    <x-text-input id="title" class="block mt-1 w-full" type="text" name="title"
                        :value="old('title', $share_quiz->title)" required autofocus autocomplete="title" />
                ...
                <div class="my-5">
                    ...
                    <x-text-input id="description" class="block mt-1 w-full" type="text" name="description"
                        :value="old('description', $share_quiz->description)" required autofocus autocomplete="description" />
                ...
                <div class="my-5 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        @if (!is_null($share_quiz->id) && $share_quiz->featured_image)
                            <img src="{{$share_quiz->featured_image}}" alt="{{__('Quiz Featured Image')}}" title="{{__('Quiz Featured Image')}}" class="my-5">
                        @endif
                        <input
                    ...
                    <div>
                        ...
                        @if (!is_null($share_quiz->id) && $share_quiz->featured_image_disabled)
                            <img src="{{$share_quiz->featured_image_disabled}}" alt="{{__('Quiz Disabled Image')}}" title="{{__('Quiz Disabled Image')}}" class="my-5">
                        @endif
                        <input
                            class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                ...
                <div class="my-5">
                    ...
                    <x-text-input id="slug" class="block mt-1 w-full" type="text" name="slug"
                        :value="old('slug', $share_quiz->slug)" required autofocus autocomplete="slug" />
                    <x-input-error :messages="$errors->get('slug')" class="mt-2" />
                </div>

                <div class="my-5">
                    <x-input-label for="share_url" :value="__('Share URL')" />
                    <x-text-input id="share_url" class="block mt-1 w-full" type="text" name="share_url"
                        :value="old('share_url', $share_quiz->share_url)" required autofocus autocomplete="share_url" />
                    <x-input-error :messages="$errors->get('share_url')" class="mt-2" />
                </div>

                <div class="my-5">
                    <x-input-label for="share_text" :value="__('Share text')" />
                    <x-text-input id="share_text" class="block mt-1 w-full" type="text" name="share_text"
                        :value="old('share_text', $share_quiz->share_text)" required autofocus autocomplete="share_text" />
                    <x-input-error :messages="$errors->get('share_text')" class="mt-2" />
                </div>
                ...
                <div class="my-5 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input id="init_date" name="init_date" value="{{ old('init_date', $share_quiz->init_date) }}" type="text" 
                    ...
                    <div>
                        ...
                        <input id="end_date" name="end_date" value="{{ old('end_date', $share_quiz->end_date) }}" 
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="{{ __('Select date') }}">
                ...
                <div class="my-5">
                    ...
                    @if (!is_null($share_quiz->id) && $share_quiz->featured_image_url)
                        <div id="delete_image_holder" class="relative">
                            <img src="{{$share_quiz->featured_image_url}}" alt="{{__('Quiz Featured Image')}}" title="{{__('Quiz Featured Image')}}" class="my-5 w-full">
                ...
                <div class="my-5">
                    ...
                    @if (!is_null($share_quiz->id) && $share_quiz->featured_video_url)
                    ...
                    <x-text-input id="featured_video_url" class="block mt-1 w-full" type="text" name="featured_video_url"
                        :value="old('featured_video_url', $share_quiz->featured_video_url)" autofocus autocomplete="featured_video_url" />
                ...
                <div class="my-5 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <x-text-input id="gradient_1" class="block mt-1 w-full" type="text" name="gradient_1"
                            :value="old('gradient_1', $share_quiz->gradient_1)" required autofocus autocomplete="gradient_1" />
                    ...
                    <div>
                        ...
                        <x-text-input id="gradient_2" class="block mt-1 w-full" type="text" name="gradient_2"
                            :value="old('gradient_2', $share_quiz->gradient_2)" required autofocus autocomplete="gradient_2" />
                ...
                <div class="my-5 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <x-text-input id="btn_background_color_1" class="block mt-1 w-full" type="text" name="btn_background_color_1"
                            :value="old('btn_background_color_1', $share_quiz->btn_background_color_1)" required autofocus autocomplete="btn_background_color_1" />
                    ...
                    <div>
                        ...
                        <x-text-input id="btn_background_color_2" class="block mt-1 w-full" type="text" name="btn_background_color_2"
                            :value="old('btn_background_color_2', $share_quiz->btn_background_color_2)" required autofocus autocomplete="btn_background_color_2" />
                ...
                <div class="my-5 grid grid-cols-2 gap-4">
                    <div>
                        <input id="btn_border" name="btn_border" type="checkbox" value="1" {{$share_quiz->btn_border ? 'checked' : ''}}
                        ...
                        <div class="mt-3">
                            ...
                            <x-text-input id="btn_border_color" class="block mt-1 w-full" type="text" name="btn_border_color"
                                :value="old('btn_border_color', $share_quiz->btn_border_color)" required autofocus autocomplete="btn_border_color" />
                    ...
                    <div>
                        <input id="btn_shadow" name="btn_shadow" type="checkbox" value="1" {{$share_quiz->btn_shadow ? 'checked' : ''}}
                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <div class="mt-3">
                            ...
                            <x-text-input id="btn_text_color" class="block mt-1 w-full" type="text" name="btn_text_color"
                                :value="old('btn_text_color', $share_quiz->btn_text_color)" required autofocus autocomplete="btn_text_color" />
                ...
                <div class="my-5 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <x-text-input id="btn_text_active" class="block mt-1 w-full" type="text" name="btn_text_active"
                            :value="old('btn_text_active', $share_quiz->btn_text_active)" required autofocus autocomplete="btn_text_active" />
                    ...
                    <div>
                        ...
                        <x-text-input id="btn_text_inactive" class="block mt-1 w-full" type="text" name="btn_text_inactive"
                            :value="old('btn_text_inactive', $share_quiz->btn_text_inactive)" required autofocus autocomplete="btn_text_inactive" />
                ...
                <div class="my-5">
                    ...
                    @if ($share_quiz->game_banner)
                        <div id="delete_image_holder_2" class="relative">
                            <img src="{{$share_quiz->game_banner}}" alt="{{__('Banner Image')}}" title="{{__('Banner Image')}}" class="my-5 w-full">
                            <x-delete-image :element="'delete_image_holder_2'"></x-delete-image>
                        </div>
                        <input type="hidden" id="delete_image_holder_2_hidden" name="delete_image_holder_2_hidden" value="0">
                    @endif
                    <input
                        class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                ...
                <div class="my-5">
                    ...
                    <x-text-input id="game_banner_url" class="block mt-1 w-full" type="text" name="game_banner_url"
                        :value="old('game_banner_url', $share_quiz->game_banner_url)" autofocus autocomplete="game_banner_url" />
                    <x-input-error :messages="$errors->get('game_banner_url')" class="mt-2" />
                </div>
                <div class="my-5">
                    <x-input-label for="game_banner_video" :value="__('Video')" />
                    @if (!is_null($share_quiz->id) && $share_quiz->game_banner_video)
                    <div class="aspect-w-16 aspect-h-9 mb-6">
                    ...
                    <x-text-input id="game_banner_video" class="block mt-1 w-full" type="text" name="game_banner_video"
                        :value="old('game_banner_video', $share_quiz->game_banner_video)" autofocus autocomplete="game_banner_video" />
        ...
        <div class="py-6 mx-5">
            <div class="max-w-2xl mx-auto sm:px-6 lg:px-8 bg-white p-3 rounded shadow">
                <div class="flex justify-between">
                    ...
                    @if (is_null($share_quiz->award))
                        <a href="{{ route('awards.create', ['tenant' => tenant('id'), 'awardable_id' => $share_quiz, 'awardable_type' => 'App\Models\ShareQuiz' ]) }}"
                            ...
                            <tbody>
                                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                    <th scope="row" class="px-6 py-4">
                                        {!!$share_quiz->award->title!!}
                                    </th>
                                    <td class="px-6 py-4">
                                        <a href="{{ route('awards.edit', ['tenant' => tenant('id'), 'award' => $share_quiz->award]) }}"
        ...
        <script>
            document.addEventListener("DOMContentLoaded", () => {
                ...
                const gradient3 = new ColorPicker({
                    color: '{{$share_quiz->btn_background_color_1}}',
                    background: '#fff',
                ...
                const gradient4 = new ColorPicker({
                    color: '{{$share_quiz->btn_background_color_2}}',
                    background: '#fff',
                ...
                const gradient5 = new ColorPicker({
                    color: '{{$share_quiz->btn_border_color}}',
                    background: '#fff',
                ...
                const gradient6 = new ColorPicker({
                    color: '{{$share_quiz->btn_text_color}}',
                    background: '#fff',
