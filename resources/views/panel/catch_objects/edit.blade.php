    ...
    <div class="py-6 mx-5">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8 bg-white p-3 rounded shadow">
            <form method="POST" enctype="multipart/form-data"
                action="{{ $catch_object->id == null ? route('catch_objects.store', ['tenant' => tenant('id')]) : route('catch_objects.update', ['tenant' => tenant('id'), 'catch_object' => $catch_object]) }}">
                @csrf
                ...
                <div class="flex my-5">
                    ...
                    @if (!is_null($catch_object->id))
                        <a href="{{ route('catch_objects.edit', ['tenant' => tenant('id'), 'catch_object' => $catch_object]) }}"
