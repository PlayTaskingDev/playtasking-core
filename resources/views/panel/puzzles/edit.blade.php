<x-panel-layout>
    <x-slot name="title">
        {{ !is_null($puzzle->title) ? $puzzle->title : trans('Create') . '' . trans('Puzzle') }}
    </x-slot>
    ...
    <x-slot name="header">
        <h1 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ $puzzle->id == null ? trans('Create') : trans('Edit') }} {{ __('Puzzle') }}
        </h1>
    </x-slot>
    ...
    <div class="py-6 mx-5">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8 bg-white p-3 rounded shadow">
            <form method="POST" enctype="multipart/form-data"
                action="{{ $puzzle->id == null ? route('puzzles.store', ['tenant' => tenant('id')]) : route('puzzles.update', ['tenant' => tenant('id'), 'puzzle' => $puzzle]) }}">
                @csrf
                @isset($puzzle->id)
                    @method('PATCH')
                    ...
                    <select id="campaign_id" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="campaign_id" required autofocus>
                        ...
                        @if ($campaigns)
                            @foreach ($campaigns as $campaign)
                                <option value="{{$campaign->id}}" {{(old('campaign_id') == $campaign->id ? 'selected' : (isset($puzzle->campaign) && $puzzle->campaign->id == $campaign->id ? 'selected' : ''))}}>{{$campaign->name}}</option>
                            @endforeach
                        @endif
                    </select>
                ...
                <div class="my-5">
                    ...
                    <x-text-input id="title" class="block mt-1 w-full" type="text" name="title"
                        :value="old('title', $puzzle->title)" required autofocus autocomplete="title" />
                ...
                <div class="my-5">
                    ...
                    <x-text-input id="description" class="block mt-1 w-full" type="text" name="description"
                        :value="old('description', $puzzle->description)" required autofocus autocomplete="description" />
                ...
                <div class="my-5 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        @if (!is_null($puzzle->id) && $puzzle->featured_image)
                            <img src="{{$puzzle->featured_image}}" alt="{{__('Quiz Featured Image')}}" title="{{__('Quiz Featured Image')}}" class="my-5">
                        @endif
                        <input
                    ...
                    <div>
                        ...
                        @if (!is_null($puzzle->id) && $puzzle->featured_image_disabled)
                            <img src="{{$puzzle->featured_image_disabled}}" alt="{{__('Quiz Disabled Image')}}" title="{{__('Quiz Disabled Image')}}" class="my-5">
                        @endif
                        <input
                            class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                ...
                <div class="my-5">
                    ...
                    <x-text-input id="slug" class="block mt-1 w-full" type="text" name="slug"
                        :value="old('slug', $puzzle->slug)" required autofocus autocomplete="slug" />
                ...
                <div class="my-5">
                    ...
                    <x-text-input id="seconds" class="block mt-1 w-full" type="number" name="seconds"
                        :value="old('seconds', $puzzle->seconds)" required autofocus autocomplete="seconds" />
                    <x-input-error :messages="$errors->get('seconds')" class="mt-2" />
                </div>

                <div class="my-5">
                    <x-input-label for="pieces" :value="__('Pieces')" />
                    <x-text-input id="pieces" class="block mt-1 w-full" type="number" name="pieces"
                        :value="old('pieces', $puzzle->pieces)" required autofocus autocomplete="pieces" />
                ...
                <div class="my-5 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input id="init_date" name="init_date" value="{{ old('init_date', $puzzle->init_date) }}" type="text" 
                    ...
                    <div>
                        ...
                        <input id="end_date" name="end_date" value="{{ old('end_date', $puzzle->end_date) }}" 
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="{{ __('Select date') }}">
                ...
                <div class="my-5 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <x-text-input id="gradient_1" class="block mt-1 w-full" type="text" name="gradient_1"
                            :value="old('gradient_1', $puzzle->gradient_1)" required autofocus autocomplete="gradient_1" />
                    ...
                    <div>
                        ...
                        <x-text-input id="gradient_2" class="block mt-1 w-full" type="text" name="gradient_2"
                            :value="old('gradient_2', $puzzle->gradient_2)" required autofocus autocomplete="gradient_2" />
                ...
                <div class="my-5 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <x-text-input id="btn_background_color_1" class="block mt-1 w-full" type="text" name="btn_background_color_1"
                            :value="old('btn_background_color_1', $puzzle->btn_background_color_1)" required autofocus autocomplete="btn_background_color_1" />
                    ...
                    <div>
                        ...
                        <x-text-input id="btn_background_color_2" class="block mt-1 w-full" type="text" name="btn_background_color_2"
                            :value="old('btn_background_color_2', $puzzle->btn_background_color_2)" required autofocus autocomplete="btn_background_color_2" />
                ...
                <div class="my-5 grid grid-cols-2 gap-4">
                    <div>
                        <input id="btn_border" name="btn_border" type="checkbox" value="1" {{$puzzle->btn_border ? 'checked' : ''}}
                        ...
                        <div class="mt-3">
                            ...
                            <x-text-input id="btn_border_color" class="block mt-1 w-full" type="text" name="btn_border_color"
                                :value="old('btn_border_color', $puzzle->btn_border_color)" required autofocus autocomplete="btn_border_color" />
                    ...
                    <div>
                        <input id="btn_shadow" name="btn_shadow" type="checkbox" value="1" {{$puzzle->btn_shadow ? 'checked' : ''}}
                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <div class="mt-3">
                            ...
                            <x-text-input id="btn_text_color" class="block mt-1 w-full" type="text" name="btn_text_color"
                                :value="old('btn_text_color', $puzzle->btn_text_color)" required autofocus autocomplete="btn_text_color" />
                ...
                <div class="my-5 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <x-text-input id="btn_text_active" class="block mt-1 w-full" type="text" name="btn_text_active"
                            :value="old('btn_text_active', $puzzle->btn_text_active)" required autofocus autocomplete="btn_text_active" />
                    ...
                    <div>
                        ...
                        <x-text-input id="btn_text_inactive" class="block mt-1 w-full" type="text" name="btn_text_inactive"
                            :value="old('btn_text_inactive', $puzzle->btn_text_inactive)" required autofocus autocomplete="btn_text_inactive" />
                ...
                <div class="my-5">
                    ...
                    @if ($puzzle->game_banner)
                        <div id="delete_image_holder" class="relative">
                            <img src="{{$puzzle->game_banner}}" alt="{{__('Banner Image')}}" title="{{__('Banner Image')}}" class="my-5 w-full">
                ...
                <div class="my-5">
                    ...
                    <x-text-input id="game_banner_url" class="block mt-1 w-full" type="text" name="game_banner_url"
                        :value="old('game_banner_url', $puzzle->game_banner_url)" autofocus autocomplete="game_banner_url" />
                    <x-input-error :messages="$errors->get('game_banner_url')" class="mt-2" />
                </div>
                <div class="my-5">
                    <x-input-label for="game_banner_video" :value="__('Video')" />
                    @if (!is_null($puzzle->id) && $puzzle->game_banner_video)
                    ...
                    <x-text-input id="game_banner_video" class="block mt-1 w-full" type="text" name="game_banner_video"
                        :value="old('game_banner_video', $puzzle->game_banner_video)" autofocus autocomplete="game_banner_video" />
                ...
                <div class="my-5 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        @if (!is_null($puzzle->id) && $puzzle->failed_image)
                            <img src="{{$puzzle->failed_image}}" alt="{{__('Quiz Failed Image')}}" title="{{__('Quiz Failed Image')}}" class="my-5">
                        @endif
                        <input
                            class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                    ...
                    <div>
                        <x-input-label for="puzzle_image" :value="__('Puzzle Image')" />
                        @if (!is_null($puzzle->id) && $puzzle->puzzle_image)
                            <img src="{{$puzzle->puzzle_image}}" alt="{{__('Puzzle Image')}}" title="{{__('Puzzle Image')}}" class="my-5">
                        @endif
                        <input
                            class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                            aria-describedby="puzzle_image_help" id="puzzle_image" name="puzzle_image" type="file">
                        <x-input-error class="mt-2" :messages="$errors->get('puzzle_image')" />
                        <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="puzzle_image_help">
                            {{__('Image must be less than 2MB and JPG or PNG format.')}}<br>
                            {{__('Dimensions must be')}} 680 x 1024
                        </div>
                    </div>
                </div>
            ...
            <div class="max-w-2xl mx-auto sm:px-6 lg:px-8 bg-white p-3 rounded shadow">
                <div class="flex justify-between">
                    ...
                    @if (is_null($puzzle->award))
                        <a href="{{ route('awards.create', ['tenant' => tenant('id'), 'awardable_id' => $puzzle, 'awardable_type' => 'App\Models\Puzzle' ]) }}"
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('awards.edit', ['tenant' => tenant('id'), 'award' => $puzzle->award]) }}"
        ...
        <script>
            document.addEventListener("DOMContentLoaded", () => {
                ...
                const gradient3 = new ColorPicker({
                    color: '{{$puzzle->btn_background_color_1}}',
                    background: '#fff',
                ...
                const gradient4 = new ColorPicker({
                    color: '{{$puzzle->btn_background_color_2}}',
                    background: '#fff',
