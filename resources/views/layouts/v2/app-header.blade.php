<header
    class="sticky top-0 flex w-full bg-white border-gray-200 z-999 dark:border-gray-800 dark:bg-gray-900 xl:border-b"
    x-data="{
    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <a href="/" class="xl:hidden">
                <img class="dark:hidden" src="{{get_app_setting('app_logo')}}" alt="Logo" />
                <img class="hidden dark:block" src="{{get_app_setting('app_logo')}}" alt="Logo" />
            </a>
