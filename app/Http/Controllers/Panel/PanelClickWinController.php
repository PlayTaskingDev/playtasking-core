...
class PanelClickWinController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('panel.click_wins.index', [
    ...
    public function create()
    {
        ...
        return view('panel.click_wins.edit', [
            'click_win'     => $click_win,
            'campaigns'     => $campaigns,
    ...
    public function store(SaveClickWinRequest $request)
    {
        ...
        return redirect(route('click_wins.index', ['tenant' => tenant('id')]))->with('status', trans('Click and win saved successful'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(ClickWin $click_win)
    {
        $campaigns = Campaign::all();
        $content_type = ContentType::where('system_name','games')->first();
        $time_slots = get_time_slots();
    ...
    public function destroy(ClickWin $click_win)
    {
        ...
        return redirect(route('click_wins.index', ['tenant' => tenant('id')]))->with('status', trans('Click and win deleted successful'));
    }
}
