...
class PanelAnswerController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('panel.answers.edit', [
            'answer'        => $answer,
    ...
    public function store(SaveAnswerRequest $request)
    {
        ...
        return redirect(route('answers.edit', ['tenant' => tenant('id'), 'answer' => $answer]))->with('status', trans('Answer saved successful'));
    }
