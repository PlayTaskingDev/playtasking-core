...
class PanelPuzzleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('panel.puzzles.index', [
    ...
    public function create()
    {
        ...
        return view('panel.puzzles.edit', [
            'puzzle'        => $puzzle,
            'campaigns'     => $campaigns,
    ...
    public function store(SavePuzzleRequest $request)
    {
        ...
        return redirect(route('puzzles.index', ['tenant' => tenant('id')]))->with('status', trans('Puzzle saved successful'));
    }
    ...
    public function destroy(Puzzle $puzzle)
    {
        ...
        return redirect(route('puzzles.index', ['tenant' => tenant('id')]))->with('status', trans('Puzzle deleted successful'));
    }
}
