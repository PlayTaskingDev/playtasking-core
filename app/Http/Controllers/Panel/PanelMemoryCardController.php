...
class PanelMemoryCardController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('panel.memory_cards.edit', [
    ...
    public function store(SaveMemoryCardRequest $request)
    {
        ...
        return redirect(route('memory_cards.edit', ['tenant' => tenant('id'), 'memory_card' => $memory_card]))->with('status', trans('Memory card saved successful'));
    }
    ...
    public function update(SaveMemoryCardRequest $request, MemoryCard $memory_card)
    {
        ...
        return redirect(route('memory_cards.edit', ['tenant' => tenant('id'), 'memory_card' => $memory_card]))->with('status', trans('Card saved successful'));
    }
