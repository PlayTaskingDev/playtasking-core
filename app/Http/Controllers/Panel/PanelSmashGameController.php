...
class PanelSmashGameController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('panel.smash_games.index', [
     ...
     */
    public function edit(SmashGame $smash_game)
    {
        $campaigns = Campaign::all();
        $content_type = ContentType::where('system_name','games')->first();
        $time_slots = get_time_slots();
    ...
    public function destroy(SmashGame $smash_game)
    {
        ...
        return redirect(route('smash_games.index', ['tenant' => tenant('id')]))->with('status', trans('Smash Game deleted successful'));
    }
}
