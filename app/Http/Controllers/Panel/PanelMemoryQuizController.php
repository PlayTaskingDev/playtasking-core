...
class PanelMemoryQuizController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('panel.memory_quizzes.index', [
    ...
    public function create()
    {
        ...
        return view('panel.memory_quizzes.edit', [
    ...
    public function store(SaveMemoryQuizRequest $request)
    {
        ...
        return redirect(route('memory_quizzes.index', ['tenant' => tenant('id')]))->with('status', trans('Memory quiz saved successful'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(MemoryQuiz $memoryQuiz)
    {
        $campaigns = Campaign::all();
        $content_type = ContentType::where('system_name','games')->first();
        $time_slots = get_time_slots();
    ...
    public function destroy(MemoryQuiz $memoryQuiz)
    {
        ...
        return redirect(route('memory_quizzes.index', ['tenant' => tenant('id')]))->with('status', trans('Memory quiz deleted successful'));
    }
}
