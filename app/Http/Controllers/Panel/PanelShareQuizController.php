...
class PanelShareQuizController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('panel.share_quizzes.index', [
    ...
    public function create()
    {
        ...
        return view('panel.share_quizzes.edit', [
    ...
    public function store(SaveShareQuizRequest $request)
    {
        ...
        return redirect(route('share_quizzes.index', ['tenant' => tenant('id')]))->with('status', trans('Share quiz saved successful'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(ShareQuiz $shareQuiz)
    {
        $campaigns = Campaign::all();
        $content_type = ContentType::where('system_name','games')->first();
        $time_slots = get_time_slots();
    ...
    public function destroy(ShareQuiz $shareQuiz)
    {
        ...
        return redirect(route('share_quizzes.index', ['tenant' => tenant('id')]))->with('status', trans('Share quiz deleted successful'));
    }
}
