...
class TicketAnswerController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.ticketquestions.createanswer', [
    ...
    public function store(SaveTicketAnswerRequest $request)
    {
        ...
        return redirect(route('ticketanswers.edit', ['tenant' => tenant('id'), 'ticketAnswer' => $ticketAnswer]))->with('status', trans('Answer saved successful'));
    }
    ...
    public function destroy(TicketAnswer $ticketAnswer)
    {
        ...
        return redirect(route('ticketquestions.edit', ['tenant' => tenant('id'), 'ticketquestion' => $ticket_question]))->with('status', trans('Question saved successful'));
    }
