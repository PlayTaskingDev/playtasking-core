...
class TicketQuestionController extends Controller
{
    public function index()
    {
        ...
        return response()->view('admin.ticketquestions.index',[
    ...
    public function create()
    {
        ...
        return view('admin.ticketquestions.edit', [
    ...
    public function store(SaveTicketQuestionRequest $request)
    {
        ...
        return redirect(route('ticketquestions.edit', ['tenant' => tenant('id'), 'ticketQuestion' => $ticketQuestion]))->with('status', trans('Question saved successful'));
    }
    ...
    {
        return response()->view('admin.ticketquestions.import',[
    ...
    public function import(ImportTicketQuestionRequest $request)
    {
        ...
        try {
            ...
            return redirect(route('ticketquestions.index', ['tenant' => tenant('id')]))->with('status', trans('Questions saved successful'));
    ...
    public function destroy(TicketQuestion $ticketQuestion)
    {
        ...
        return redirect(route('ticketquestions.index', ['tenant' => tenant('id')]))->with('status', trans('Question deleted successful'));
    }
}
