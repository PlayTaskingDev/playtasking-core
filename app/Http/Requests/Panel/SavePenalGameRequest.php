...
class SavePenalGameRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'points_per_goal' => ['required','numeric'],
            ...
            'game_bg_image_desktop'     => [Rule::requiredIf(!$this->id),'image:jpg,png,jpeg','max:600'],
            'game_bg_image_movil'     => [Rule::requiredIf(!$this->id),'image:jpg,png,jpeg','max:600'],
