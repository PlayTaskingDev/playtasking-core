...
class SavePuzzleRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'slug'              => [
                'required',
                'regex:/^[a-z0-9\-]+$/',
                Rule::unique('puzzles')->ignore($this->id)
            ],
            ...
            'pieces'            => ['required','numeric','in:12,25,50,100'],
            ...
            'puzzle_image'      => [Rule::requiredIf(!$this->id),'image:jpg,png,jpeg','max:600'],
