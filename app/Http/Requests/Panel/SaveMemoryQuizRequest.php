...
class SaveMemoryQuizRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'slug'              => [
                'required',
                'regex:/^[a-z0-9\-]+$/',
                Rule::unique('memory_quizzes')->ignore($this->id)
            ],
            ...
            'back_card_image'   => [Rule::requiredIf(!$this->id),'image:jpg,png,jpeg','max:600'],
