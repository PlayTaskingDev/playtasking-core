...
class PenalGamesTableSeeder extends Seeder
{
    use CampaignsTrait;
    /**
    ...
    public function run(): void
    {
       DB::statement('SET FOREIGN_KEY_CHECKS=0;');
        ...
        $content_type_games = ContentType::where('system_name','games')->first();
         ...
         $penalGame = PenalGame::create([
            'title'             => 'Penal Game',
            'description'       => 'Penal Game Description',
            'gradient_1'        => '#ed8000',
            'gradient_2'        => '#f58c25',
            'slug'              => 'penal-game',
            'max_points'        => 100,
            ...
            'game_bg_image_desktop'     => '/storage/dummy_assets/catch-game-bg.jpg',
            'game_bg_image_movil'     => '/storage/dummy_assets/catch-game-bg.jpg',
         ...
         Award::create([
            ...
            ',
            'awardable_id'      => $penalGame->id,
            'awardable_type'    => 'App\Models\PenalGame'
        ]);
